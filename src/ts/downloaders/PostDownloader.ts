...
export class PostDownloader extends Downloader {
    ...
    public async createDownloadButton(): Promise<void> {
        let postList: HTMLElement[] = [...document.querySelectorAll(Variables.postWrapperClass)] as HTMLElement[];
    ...
    private async retryCreateButton(maxRetries: number = 20, retries: number = 0): Promise<HTMLElement[]> {
        ...
        let postList = [...document.querySelectorAll(Variables.postWrapperClass)] as HTMLElement[];
    ...
    private addDownloadButton(element: HTMLElement): void {
        const bookmarkElement: HTMLElement = element.querySelector(Variables.postBookmarkClass) as HTMLElement;
