...
export enum QuerySelectors {
    ...
    postAccountName = "._aacl > ._aap6 > .oajrlxb2, ._acan._acao._acat._acaw, ._aacl._aaco._aacw._aacx._aad6._aade, ._aaqt",
    ...
    accountName = '._7UhW9.fKFbl.yUEEX.KV-D4.fDxYl, ._aacl._aacs._aact._aacx._aada, ._acan._acao._acat._acaw, ._aacl._aaco._aacw._aacx._aad6._aade, ._aaqt',
